...
**** Answer:
This happens if a
readAs functions is called
too early on it. They shouldn't
be called before the readyState
is reported as EMPTY, indicating
that the FileReader was created
...
*** Types: Rank n                                                     :drill:
    ...
    :DRILL_EASE: 2.5
    :DRILL_LAST_QUALITY: 4
    :DRILL_LAST_REVIEWED: [2019-05-27 Mon 15:52]
    :END:
